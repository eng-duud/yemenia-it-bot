...
from handlers.admin_handlers import (
    ...
    start_manage_delegates, save_delegate, delegate_level_selected,
    start_ban_user, save_ban,
    ...
    MANAGE_DELEGATES, BAN_USER, BROADCAST_MSG
)
...
def main():
    ...
    # Admin/Delegate Conversation Handler
    admin_conv = ConversationHandler(
        entry_points=[
            CallbackQueryHandler(admin_panel, pattern="^(admin_panel|delegate_panel)$"),
            ...
            CallbackQueryHandler(start_manage_delegates, pattern="^admin_manage_delegates$"),
            CallbackQueryHandler(start_ban_user, pattern="^admin_ban_user$"),
        ...
        states={
            ...
            ADD_CONTENT_DATA: [
                ...
                MessageHandler(filters.TEXT & ~filters.COMMAND, save_content)
            ],
            MANAGE_DELEGATES: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, save_delegate),
                CallbackQueryHandler(delegate_level_selected, pattern="^level_")
            ],
            BAN_USER: [MessageHandler(filters.TEXT & ~filters.COMMAND, save_ban)],
